...
def base(data, name="Random Forest Regressor"):
    x, y = data
    ...
    model = RandomForestRegressor(
        random_state=0, min_samples_leaf=20, min_samples_split=16, n_estimators=100
    )
...
def main():
    model_v1 = base(v1(), "Random Forest Regressor - V1")
    model_v2 = base(v2(), "Random Forest Regressor - V2")
